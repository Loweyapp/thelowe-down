...
const JUL_2025 = [
  { date:'2025-07-01', description:'Car tax',                          category:'Car',              amount:-26.68,  type:'expense', account:'Alex'  },
  { date:'2025-07-01', description:'Car insurance',                    category:'Car',              amount:-53.75,  type:'expense', account:'Alex'  },
  { date:'2025-07-02', description:'Sainsbury / Tesco / Costco',       category:'Groceries',        amount:-106.25, type:'expense', account:'Alex'  },
  { date:'2025-07-02', description:'Juice',                            category:'Groceries',        amount:-1.45,   type:'expense', account:'Alex'  },
  { date:'2025-07-03', description:'Groceries',                        category:'Groceries',        amount:-10.75,  type:'expense', account:'Alex'  },
  { date:'2025-07-03', description:'Alex tube',                        category:'Transport',        amount:-4.40,   type:'expense', account:'Alex'  },
  { date:'2025-07-05', description:'Oma - Alex meal with friends',     category:'Dining Out',       amount:-109.41, type:'expense', account:'Alex'  },
  { date:'2025-07-05', description:'Audible subscription',             category:'Entertainment',    amount:-8.99,   type:'expense', account:'Alex'  },
  { date:'2025-07-05', description:'Alex drinks',                      category:'Dining Out',       amount:-16.10,  type:'expense', account:'Alex'  },
  { date:'2025-07-05', description:'Alex drinks',                      category:'Dining Out',       amount:-25.20,  type:'expense', account:'Alex'  },
  { date:'2025-07-05', description:'Alex tube',                        category:'Transport',        amount:-6.80,   type:'expense', account:'Alex'  },
  { date:'2025-07-05', description:'Drinks',                           category:'Dining Out',       amount:-22.80,  type:'expense', account:'Alex'  },
  { date:'2025-07-06', description:'Alex uber trip',                   category:'Transport',        amount:-1.00,   type:'expense', account:'Alex'  },
  { date:'2025-07-07', description:'Netflix subscription',             category:'Subscriptions',    amount:-12.99,  type:'expense', account:'Alex'  },
  { date:'2025-07-07', description:'Groceries',                        category:'Groceries',        amount:-21.09,  type:'expense', account:'Alex'  },
  { date:'2025-07-07', description:'Alex podcast subscription',        category:'Subscriptions',    amount:-6.00,   type:'expense', account:'Alex'  },
  { date:'2025-07-07', description:'Alex kebab',                       category:'Dining Out',       amount:-12.90,  type:'expense', account:'Alex'  },
  { date:'2025-07-07', description:"Alex's hair cut",                  category:'Other',            amount:-25.00,  type:'expense', account:'Alex'  },
  { date:'2025-07-08', description:'Car cleaning stuff',               category:'Car',              amount:-18.79,  type:'expense', account:'Alex'  },
  { date:'2025-07-08', description:'Prime video',                      category:'Subscriptions',    amount:-7.99,   type:'expense', account:'Alex'  },
  { date:'2025-07-08', description:'Chinese takeaway',                 category:'Dining Out',       amount:-40.20,  type:'expense', account:'Alex'  },
  { date:'2025-07-09', description:'Groceries',                        category:'Groceries',        amount:-15.40,  type:'expense', account:'Alex'  },
  { date:'2025-07-13', description:'Foods etc during Wales trip',      category:'Holiday & Travel', amount:-35.00,  type:'expense', account:'Alex'  },
  { date:'2025-07-13', description:'KJ expense during Wales trip',     category:'Holiday & Travel', amount:-43.50,  type:'expense', account:'Kelly' },
  { date:'2025-07-14', description:'Drinks',                           category:'Groceries',        amount:-6.70,   type:'expense', account:'Alex'  },
  { date:'2025-07-14', description:'Takeaway dinner',                  category:'Dining Out',       amount:-31.20,  type:'expense', account:'Alex'  },
  { date:'2025-07-14', description:'Wine in Wales',                    category:'Holiday & Travel', amount:-38.00,  type:'expense', account:'Alex'  },
  { date:'2025-07-15', description:'Alex photo book',                  category:'Entertainment',    amount:-25.27,  type:'expense', account:'Alex'  },
  { date:'2025-07-15', description:'Wasps stuff - candle etc',         category:'Home & Garden',    amount:-32.96,  type:'expense', account:'Alex'  },
  { date:'2025-07-15', description:"Groceries - bbq, Alex's shirts",   category:'Groceries',        amount:-160.24, type:'expense', account:'Alex'  },
  { date:'2025-07-15', description:'Alex google channel',              category:'Subscriptions',    amount:-4.99,   type:'expense', account:'Alex'  },
  { date:'2025-07-15', description:"Savings card - Sainsbury's",       category:'Groceries',        amount:-95.00,  type:'expense', account:'Kelly' },
  { date:'2025-07-16', description:'Bedding set',                      category:'Home & Garden',    amount:-169.00, type:'expense', account:'Alex'  },
  { date:'2025-07-16', description:'National lottery',                 category:'Entertainment',    amount:-10.00,  type:'expense', account:'Alex'  },
  { date:'2025-07-16', description:'Internet broadband',               category:'Bills & Utilities',amount:-36.54,  type:'expense', account:'Alex'  },
  { date:'2025-07-16', description:'KJ Apple storage',                 category:'Subscriptions',    amount:-2.99,   type:'expense', account:'Kelly' },
  { date:'2025-07-17', description:"Alex's new phone",                 category:'Shopping',         amount:-602.49, type:'expense', account:'Alex'  },
  { date:'2025-07-17', description:'Books for work',                   category:'Other',            amount:-12.00,  type:'expense', account:'Alex'  },
  { date:'2025-07-17', description:'A book for work',                  category:'Other',            amount:-7.34,   type:'expense', account:'Alex'  },
  { date:'2025-07-17', description:'Groceries',                        category:'Groceries',        amount:-19.71,  type:'expense', account:'Alex'  },
  { date:'2025-07-17', description:'Alex Floy models membership',      category:'Entertainment',    amount:-4.80,   type:'expense', account:'Alex'  },
  { date:'2025-07-18', description:'Kelly flower arrangement course',  category:'Other',            amount:-1.18,   type:'expense', account:'Kelly' },
  { date:'2025-07-18', description:'Screen protector',                 category:'Shopping',         amount:-4.99,   type:'expense', account:'Alex'  },
  { date:'2025-07-18', description:'Groceries',                        category:'Groceries',        amount:-19.95,  type:'expense', account:'Alex'  },
  { date:'2025-07-19', description:'Kelly dinner out',                 category:'Dining Out',       amount:-21.50,  type:'expense', account:'Kelly' },
  { date:'2025-07-19', description:'Kelly tube - New Malden',          category:'Transport',        amount:-10.30,  type:'expense', account:'Kelly' },
  { date:'2025-07-19', description:'Kelly Three Mobile top up',        category:'Bills & Utilities',amount:-5.00,   type:'expense', account:'Kelly' },
  { date:'2025-07-20', description:"Sainsbury's",                      category:'Groceries',        amount:-12.48,  type:'expense', account:'Alex'  },
  { date:'2025-07-20', description:'Groceries',                        category:'Groceries',        amount:-12.48,  type:'expense', account:'Alex'  },
  { date:'2025-07-21', description:'Expenses for Wales trip',          category:'Holiday & Travel', amount:-173.02, type:'expense', account:'Alex'  },
  { date:'2025-07-21', description:'Alex Google storage',              category:'Bills & Utilities',amount:-7.99,   type:'expense', account:'Alex'  },
  { date:'2025-07-21', description:'Groceries',                        category:'Groceries',        amount:-21.99,  type:'expense', account:'Alex'  },
  { date:'2025-07-21', description:'Kelly tube until 15th July',       category:'Transport',        amount:-22.10,  type:'expense', account:'Kelly' },
  { date:'2025-07-22', description:'Alex drinks',                      category:'Dining Out',       amount:-32.19,  type:'expense', account:'Alex'  },
  { date:'2025-07-22', description:'Alex drinks',                      category:'Dining Out',       amount:-59.63,  type:'expense', account:'Alex'  },
  { date:'2025-07-22', description:'Alex drinks',                      category:'Dining Out',       amount:-24.45,  type:'expense', account:'Alex'  },
  { date:'2025-07-22', description:'Alex lunch at work',               category:'Dining Out',       amount:-14.76,  type:'expense', account:'Alex'  },
  { date:'2025-07-22', description:'Alex tube',                        category:'Transport',        amount:-4.60,   type:'expense', account:'Alex'  },
  { date:'2025-07-22', description:"Sainsbury's",                      category:'Groceries',        amount:-9.00,   type:'expense', account:'Kelly' },
  { date:'2025-07-23', description:'Alex mobile charge',               category:'Bills & Utilities',amount:-5.00,   type:'expense', account:'Alex'  },
  { date:'2025-07-23', description:'Alex drinks',                      category:'Dining Out',       amount:-15.00,  type:'expense', account:'Alex'  },
  { date:'2025-07-23', description:"Sainsbury's",                      category:'Groceries',        amount:-18.80,  type:'expense', account:'Alex'  },
  { date:'2025-07-23', description:'Alex bank fee',                    category:'Bills & Utilities',amount:-11.95,  type:'expense', account:'Alex'  },
  { date:'2025-07-23', description:'Bed payment instalment',           category:'Home & Garden',    amount:-75.70,  type:'expense', account:'Alex'  },
  { date:'2025-07-23', description:'Kelly salary',                     category:'Other',            amount:896.01,  type:'income',  account:'Kelly' },
  { date:'2025-07-23', description:"KJ dinner with Aesthetic biz",     category:'Dining Out',       amount:-41.78,  type:'expense', account:'Kelly' },
  { date:'2025-07-23', description:'Kelly tube',                       category:'Transport',        amount:-6.80,   type:'expense', account:'Kelly' },
  { date:'2025-07-24', description:'Alex drinks',                      category:'Dining Out',       amount:-5.65,   type:'expense', account:'Alex'  },
  { date:'2025-07-24', description:'Alex drinks',                      category:'Dining Out',       amount:-5.75,   type:'expense', account:'Alex'  },
  { date:'2025-07-24', description:'Alex drinks',                      category:'Dining Out',       amount:-21.30,  type:'expense', account:'Alex'  },
  { date:'2025-07-24', description:"Alex colleague's leaving",         category:'Gifts',            amount:-5.24,   type:'expense', account:'Alex'  },
  { date:'2025-07-24', description:'Filters for cooker',               category:'Home & Garden',    amount:-22.94,  type:'expense', account:'Alex'  },
  { date:'2025-07-25', description:'Costco',                           category:'Groceries',        amount:-97.80,  type:'expense', account:'Alex'  },
  { date:'2025-07-25', description:"KJ - Delia's retirement",          category:'Gifts',            amount:-11.69,  type:'expense', account:'Kelly' },
  { date:'2025-07-25', description:"Savings card - Sainsbury's",       category:'Groceries',        amount:-95.00,  type:'expense', account:'Kelly' },
  { date:'2025-07-26', description:'Asda party stuff',                 category:'Groceries',        amount:-40.94,  type:'expense', account:'Alex'  },
  { date:'2025-07-28', description:"Alex's salary",                    category:'Other',            amount:3578.44, type:'income',  account:'Alex'  },
  { date:'2025-07-28', description:'House rent',                       category:'Bills & Utilities',amount:-500.00, type:'expense', account:'Alex'  },
  { date:'2025-07-29', description:'Seoul plaza',                      category:'Groceries',        amount:-3.58,   type:'expense', account:'Kelly' },
  { date:'2025-07-29', description:'Train to Spacelabs',               category:'Transport',        amount:-21.50,  type:'expense', account:'Kelly' },
  { date:'2025-07-30', description:'Peaches',                          category:'Groceries',        amount:-1.52,   type:'expense', account:'Alex'  },
  { date:'2025-07-30', description:"Sainsbury's",                      category:'Groceries',        amount:-7.23,   type:'expense', account:'Alex'  },
  { date:'2025-07-31', description:'Alex lunch at work',               category:'Dining Out',       amount:-8.30,   type:'expense', account:'Alex'  },
  { date:'2025-07-31', description:'Alex tube',                        category:'Transport',        amount:-8.00,   type:'expense', account:'Alex'  },
];

const AUG_2025 = [
  { date:'2025-08-01', description:'Groceries',                        category:'Groceries',        amount:-6.86,   type:'expense', account:'Alex'  },
  { date:'2025-08-01', description:'Car tax',                          category:'Car',              amount:-26.68,  type:'expense', account:'Alex'  },
  { date:'2025-08-01', description:'Car insurance',                    category:'Car',              amount:-53.75,  type:'expense', account:'Alex'  },
  { date:'2025-08-01', description:'Tesco',                            category:'Groceries',        amount:-0.80,   type:'expense', account:'Kelly' },
  { date:'2025-08-02', description:'H Mart',                           category:'Groceries',        amount:-104.49, type:'expense', account:'Alex'  },
  { date:'2025-08-02', description:'Food Korea',                       category:'Groceries',        amount:-13.81,  type:'expense', account:'Alex'  },
  { date:'2025-08-03', description:'Cooling fluids',                   category:'Car',              amount:-12.03,  type:'expense', account:'Alex'  },
  { date:'2025-08-04', description:'Engine oil',                       category:'Car',              amount:-34.99,  type:'expense', account:'Alex'  },
  { date:'2025-08-04', description:'Alex entertainment book',          category:'Entertainment',    amount:-18.36,  type:'expense', account:'Alex'  },
  { date:'2025-08-04', description:'Alex cinema parking',              category:'Transport',        amount:-8.50,   type:'expense', account:'Alex'  },
  { date:'2025-08-05', description:'Audible subscription',             category:'Entertainment',    amount:-8.99,   type:'expense', account:'Alex'  },
  { date:'2025-08-05', description:'Alex cinema',                      category:'Entertainment',    amount:-8.00,   type:'expense', account:'Alex'  },
  { date:'2025-08-05', description:"Savings card - Sainsbury's",       category:'Groceries',        amount:-95.00,  type:'expense', account:'Kelly' },
  { date:'2025-08-06', description:'Kelly tube',                       category:'Transport',        amount:-6.50,   type:'expense', account:'Kelly' },
  { date:'2025-08-07', description:'Alex History podcast',             category:'Subscriptions',    amount:-6.00,   type:'expense', account:'Alex'  },
  { date:'2025-08-07', description:'Groceries',                        category:'Groceries',        amount:-2.85,   type:'expense', account:'Alex'  },
  { date:'2025-08-07', description:'Dubrovnik pass',                   category:'Holiday & Travel', amount:-71.53,  type:'expense', account:'Alex'  },
  { date:'2025-08-07', description:'Alex pub with Tom',                category:'Dining Out',       amount:-44.00,  type:'expense', account:'Alex'  },
  { date:'2025-08-07', description:'Groceries',                        category:'Groceries',        amount:-1.25,   type:'expense', account:'Alex'  },
  { date:'2025-08-08', description:'Wines',                            category:'Groceries',        amount:-33.93,  type:'expense', account:'Alex'  },
  { date:'2025-08-08', description:'Shower head',                      category:'Home & Garden',    amount:-22.94,  type:'expense', account:'Alex'  },
  { date:'2025-08-08', description:'National lottery',                 category:'Entertainment',    amount:-10.00,  type:'expense', account:'Alex'  },
  { date:'2025-08-08', description:'KJ Apple app subscription',        category:'Subscriptions',    amount:-22.50,  type:'expense', account:'Kelly' },
  { date:'2025-08-09', description:'International supermarket',        category:'Groceries',        amount:-8.84,   type:'expense', account:'Alex'  },
  { date:'2025-08-09', description:'Pastry',                           category:'Dining Out',       amount:-5.00,   type:'expense', account:'Alex'  },
  { date:'2025-08-09', description:'Kelly M&S',                        category:'Groceries',        amount:-7.69,   type:'expense', account:'Kelly' },
  { date:'2025-08-10', description:'Tesco',                            category:'Groceries',        amount:-10.64,  type:'expense', account:'Alex'  },
  { date:'2025-08-10', description:'Whitstable lunch',                 category:'Dining Out',       amount:-21.50,  type:'expense', account:'Alex'  },
  { date:'2025-08-10', description:'Whitstable lunch',                 category:'Dining Out',       amount:-34.45,  type:'expense', account:'Alex'  },
  { date:'2025-08-10', description:'Parking in Whitstable',            category:'Transport',        amount:-7.80,   type:'expense', account:'Alex'  },
  { date:'2025-08-10', description:'Table napkins',                    category:'Shopping',         amount:-8.25,   type:'expense', account:'Kelly' },
  { date:'2025-08-11', description:'Alex cinema',                      category:'Entertainment',    amount:-9.00,   type:'expense', account:'Alex'  },
  { date:'2025-08-11', description:'Alex dinner',                      category:'Dining Out',       amount:-10.75,  type:'expense', account:'Alex'  },
  { date:'2025-08-11', description:'Alex tube',                        category:'Transport',        amount:-4.40,   type:'expense', account:'Alex'  },
  { date:'2025-08-11', description:'Parking',                          category:'Transport',        amount:-7.80,   type:'expense', account:'Alex'  },
  { date:'2025-08-11', description:'Tesco',                            category:'Groceries',        amount:-1.97,   type:'expense', account:'Kelly' },
  { date:'2025-08-12', description:'Dart bridge charge',               category:'Transport',        amount:-5.00,   type:'expense', account:'Alex'  },
  { date:'2025-08-12', description:'Kelly taxi',                       category:'Transport',        amount:-16.10,  type:'expense', account:'Kelly' },
  { date:'2025-08-12', description:'Kelly tube',                       category:'Transport',        amount:-6.90,   type:'expense', account:'Kelly' },
  { date:'2025-08-12', description:'Kelly going out',                  category:'Dining Out',       amount:-101.56, type:'expense', account:'Kelly' },
  { date:'2025-08-13', description:'Shower head holder',               category:'Home & Garden',    amount:-10.99,  type:'expense', account:'Alex'  },
  { date:'2025-08-13', description:'Amazon cable tidy',                category:'Home & Garden',    amount:-8.49,   type:'expense', account:'Alex'  },
  { date:'2025-08-13', description:'Alex podcast subscription',        category:'Subscriptions',    amount:-3.49,   type:'expense', account:'Alex'  },
  { date:'2025-08-14', description:'Google subscription',              category:'Subscriptions',    amount:-4.99,   type:'expense', account:'Alex'  },
  { date:'2025-08-14', description:'Now TV subscription',              category:'Subscriptions',    amount:-9.99,   type:'expense', account:'Alex'  },
  { date:'2025-08-14', description:'Tesco',                            category:'Groceries',        amount:-2.84,   type:'expense', account:'Kelly' },
  { date:'2025-08-15', description:'Amazon cable tidy',                category:'Home & Garden',    amount:-8.49,   type:'expense', account:'Alex'  },
  { date:'2025-08-15', description:'Alex cables',                      category:'Shopping',         amount:-7.99,   type:'expense', account:'Alex'  },
  { date:'2025-08-16', description:'International supermarket',        category:'Groceries',        amount:-7.34,   type:'expense', account:'Alex'  },
  { date:'2025-08-16', description:'KJ Apple storage',                 category:'Subscriptions',    amount:-2.99,   type:'expense', account:'Kelly' },
  { date:'2025-08-17', description:'Takeaway dinner - fish n chips',   category:'Dining Out',       amount:-25.90,  type:'expense', account:'Alex'  },
  { date:'2025-08-17', description:'Kelly eyelash extensions',         category:'Shopping',         amount:-50.00,  type:'expense', account:'Kelly' },
  { date:'2025-08-17', description:'Coffee and tea',                   category:'Dining Out',       amount:-9.05,   type:'expense', account:'Kelly' },
  { date:'2025-08-17', description:'Kelly tube',                       category:'Transport',        amount:-8.40,   type:'expense', account:'Kelly' },
  { date:'2025-08-18', description:'Alex Floy models membership',      category:'Entertainment',    amount:-4.80,   type:'expense', account:'Alex'  },
  { date:'2025-08-18', description:'Internet broadband',               category:'Bills & Utilities',amount:-36.54,  type:'expense', account:'Alex'  },
  { date:'2025-08-19', description:'Sky-scanner app',                  category:'Entertainment',    amount:-0.89,   type:'expense', account:'Alex'  },
  { date:'2025-08-19', description:'Kelly tube',                       category:'Transport',        amount:-6.80,   type:'expense', account:'Kelly' },
  { date:'2025-08-21', description:'Alex phone bill',                  category:'Bills & Utilities',amount:-5.00,   type:'expense', account:'Alex'  },
  { date:'2025-08-21', description:'Costco - for bbq',                 category:'Groceries',        amount:-180.65, type:'expense', account:'Alex'  },
  { date:'2025-08-21', description:'Aldi - for bbq',                   category:'Groceries',        amount:-15.42,  type:'expense', account:'Alex'  },
  { date:'2025-08-21', description:"Savings card - Sainsbury's",       category:'Groceries',        amount:-95.50,  type:'expense', account:'Kelly' },
  { date:'2025-08-22', description:'Kelly salary',                     category:'Other',            amount:896.01,  type:'income',  account:'Kelly' },
  { date:'2025-08-24', description:'Alex a comic book',                category:'Entertainment',    amount:-11.85,  type:'expense', account:'Alex'  },
  { date:'2025-08-24', description:'Kelly Oseyo',                      category:'Groceries',        amount:-2.59,   type:'expense', account:'Kelly' },
  { date:'2025-08-24', description:'Kelly Three Mobile top up',        category:'Bills & Utilities',amount:-10.00,  type:'expense', account:'Kelly' },
  { date:'2025-08-24', description:'Kelly book club dinner',           category:'Dining Out',       amount:-37.40,  type:'expense', account:'Kelly' },
  { date:'2025-08-24', description:'Book club wine',                   category:'Dining Out',       amount:-15.00,  type:'expense', account:'Kelly' },
  { date:'2025-08-24', description:'Kelly tube',                       category:'Transport',        amount:-6.80,   type:'expense', account:'Kelly' },
  { date:'2025-08-25', description:'Bent pipes',                       category:'Home & Garden',    amount:-13.19,  type:'expense', account:'Alex'  },
  { date:'2025-08-25', description:'Scrubber for bbq',                 category:'Home & Garden',    amount:-5.99,   type:'expense', account:'Alex'  },
  { date:'2025-08-26', description:'Paint and thinners',               category:'Entertainment',    amount:-18.96,  type:'expense', account:'Alex'  },
  { date:'2025-08-26', description:'Bulbs for the kitchen',            category:'Home & Garden',    amount:-9.49,   type:'expense', account:'Alex'  },
  { date:'2025-08-26', description:'Tesco',                            category:'Groceries',        amount:-4.52,   type:'expense', account:'Alex'  },
  { date:'2025-08-26', description:'Bed payment installment',          category:'Home & Garden',    amount:-75.70,  type:'expense', account:'Alex'  },
  { date:'2025-08-27', description:'Alex pub',                         category:'Dining Out',       amount:-7.40,   type:'expense', account:'Alex'  },
  { date:'2025-08-27', description:'Alex work lunch',                  category:'Dining Out',       amount:-10.50,  type:'expense', account:'Alex'  },
  { date:'2025-08-27', description:'Alex tube',                        category:'Transport',        amount:-12.65,  type:'expense', account:'Alex'  },
  { date:'2025-08-27', description:'HSBC bank fee',                    category:'Bills & Utilities',amount:-11.95,  type:'expense', account:'Alex'  },
  { date:'2025-08-27', description:'Kelly tube',                       category:'Transport',        amount:-8.55,   type:'expense', account:'Kelly' },
  { date:'2025-08-28', description:'Tesco',                            category:'Groceries',        amount:-7.75,   type:'expense', account:'Alex'  },
  { date:'2025-08-28', description:'House rent',                       category:'Bills & Utilities',amount:-500.00, type:'expense', account:'Alex'  },
  { date:'2025-08-28', description:'Alex salary',                      category:'Other',            amount:3579.83, type:'income',  account:'Alex'  },
  { date:'2025-08-28', description:'Kelly tube',                       category:'Transport',        amount:-3.40,   type:'expense', account:'Kelly' },
  { date:'2025-08-29', description:'Tesco',                            category:'Groceries',        amount:-25.60,  type:'expense', account:'Alex'  },
  { date:'2025-08-29', description:'Drinks and water',                 category:'Dining Out',       amount:-26.60,  type:'expense', account:'Kelly' },
  { date:'2025-08-29', description:'Tube, train to Gatwick airport',   category:'Transport',        amount:-22.10,  type:'expense', account:'Kelly' },
  { date:'2025-08-30', description:'Wood from B&Q',                    category:'Home & Garden',    amount:-28.56,  type:'expense', account:'Alex'  },
  { date:'2025-08-31', description:'Tesco',                            category:'Groceries',        amount:-13.93,  type:'expense', account:'Alex'  },
  { date:'2025-08-31', description:'Drinks & jazz bar',                category:'Holiday & Travel', amount:-39.86,  type:'expense', account:'Kelly' },
  { date:'2025-08-31', description:'Bolt in Prague',                   category:'Holiday & Travel', amount:-31.72,  type:'expense', account:'Kelly' },
];
...
const HISTORY = [
  { label: 'July 2025',      sub: '84 transactions · £3,380.75 expenses · £4,474.45 income', data: JUL_2025 },
  { label: 'August 2025',    sub: '91 transactions · £2,350.02 expenses · £4,475.84 income', data: AUG_2025 },
